...
public class AdviseMessage {
    ...
    public final static  ArrayList<String> advertisements = new ArrayList<String>() {
        {
            ...
            add("{\"id\":1008,\"type\":2,\"content\":\"<div>Вам выставили оценки по математике. Давай проверим что у тебя?</div>\",\"link\":\"http://innsgo.ru/\"}");
            ...
            add("{\"id\":1012,\"type\":2,\"content\":\"<div>Ура, разблокировано достижение “5 пятерок подряд!”, ты один из 4% получивших его в этом учебном году</div>\",\"link\":\"http://innsgo.ru/\"}");
        }
    };
     ...
     *
     */
    private static final long TIME_FOR_SENDING = 2000;
    /**
     * For WeSocket usage.
     */
